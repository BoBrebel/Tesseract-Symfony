...
class __TwigTemplate_a91ac18a09ec4d60b68da3144893d3ad92357cf218ea15ec90cd166e95675a85 extends Twig_Template
{
                    ...
                    <div class=\"row\">
                        <div class=\"col s8 offset-s2\">
                            ...
                            <div id=\"mc_embed_signup\">
                                ...
                                ";
        // line 392
        $this->loadTemplate("TesseractMOOCBundle:Registration:registerorg.html.twig", "TesseractMOOCBundle::layoutwada.html.twig", 392)->display($context);
        // line 393
        echo "                                
...
/*                     <!-- Shuffle grid -->*/
/*                     <div id="shuffle-grid" class="row">*/
/*                         <a href="{{asset('bundles/mooc/ajax/works/heisenberg-ice-cream.html')}}" class="col s12 m6 l4 picture-item ajax-link" data-groups='["food"]'>*/
/*                             <img src="images/works/ice-cream.png')}}" class="responsive-img" alt="Ice cream">*/
/*                             <h5>Heisenberg ice-cream</h5>*/
/*                         </a>*/
/*                         <a href="{{asset('bundles/mooc/ajax/works/a-joe-book-cover.html')}}" class="col s12 m6 l4 picture-item ajax-link" data-groups='["material"]'>*/
/*                             <img src="{{asset('bundles/mooc/images/works/books.png')}}" class="responsive-img" alt="Book cover">*/
/*                             <h5>A. Joe book cover</h5>*/
/*                         </a>*/
/*                         <a href="{{asset('bundles/mooc/ajax/works/wooden-series.html')}}" class="col s12 m6 l4 picture-item ajax-link" data-groups='["digital"]'>*/
/*                             <img src="{{asset('bundles/mooc/images/works/clock.png')}}" class="responsive-img" alt="Wooden clock">*/
/*                             <h5>Wooden series</h5>*/
/*                         </a>*/
/*                         <a href="{{asset('bundles/mooc/ajax/works/rubiks-triangle.html')}}" class="col s12 m6 l4 picture-item ajax-link" data-groups='["digital", "material"]'>*/
/*                             <img src="{{asset('bundles/mooc/images/works/object.png')}}" class="responsive-img" alt="Rubik's triangle">*/
/*                             <h5>Rubik's triangle</h5>*/
/*                         </a>*/
/*                         <a href="{{asset('bundles/mooc/ajax/works/old-fashioned.html')}}" class="col s12 m6 l4 picture-item ajax-link" data-groups='["material"]'>*/
/*                             <img src="{{asset('bundles/mooc/images/works/tape.png')}}" class="responsive-img" alt="Tape">*/
/*                             <h5>Old fashioned</h5>*/
/*                         </a>*/
/*                         <a href="{{asset('bundles/mooc/ajax/works/parks-and-rec.html')}}" class="col s12 m6 l4 picture-item ajax-link" data-groups='["food", "material"]'>*/
/*                             <img src="{{asset('bundles/mooc/images/works/trees.png')}}" class="responsive-img" alt="Trees">*/
/*                             <h5>Parks and recreation</h5>*/
/*                         </a>*/
/*                     </div>*/
/*                 </div>*/
...
/*                                 </div>*/
/*                             </div>*/
/*                             <img src="{{asset('bundles/mooc/images/team/121H.jpg')}}" class="responsive-img" alt="Ann Perkins">*/
/*                         </div>*/
/*                         <div class="col s12 m6">*/
/*                             <div class="description-ball"></div>*/
/*                             <div class="description center-align">*/
...
/*                                 </div>*/
/*                             </div>*/
/*                             <img src="{{asset('bundles/mooc/images/team/166H.jpg')}}" class="responsive-img" alt="Dick Cleverley">*/
/*                         </div>*/
/*                         <div class="col s12 m6">*/
/*                             <div class="description-ball"></div>*/
/*                             <div class="description center-align">*/
...
/*                                 </div>*/
/*                             </div>*/
/*                             <img src="{{asset('bundles/mooc/images/team/93H.jpg')}}" class="responsive-img" alt="Jonathan Edgar Doe">*/
/*                         </div>*/
/*                         <div class="col s12 m6">*/
/*                             <div class="description-ball"></div>*/
/*                             <div class="description center-align">*/
...
/*                                 </div>*/
/*                             </div>*/
/*                             <img src="{{asset('bundles/mooc/images/team/172H.jpg')}}" class="responsive-img" alt="Eva Green">*/
/*                         </div>*/
/*                     </div>*/
/*                 </div>*/
/*             </div>*/
...
/*                             <div id="mc_embed_signup">*/
/*                                 */
/*                                 {% include 'TesseractMOOCBundle:Registration:registerorg.html.twig' %}*/
/*                                 */
/*                                */
/*                             </div>*/
/*                             <!--End mc_embed_signup-->*/
