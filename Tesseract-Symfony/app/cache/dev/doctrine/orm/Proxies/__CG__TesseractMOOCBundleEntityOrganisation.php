 ...
 */
class Organisation extends \Tesseract\MOOCBundle\Entity\Organisation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Organisation' . "\0" . 'nom', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Organisation' . "\0" . 'adress', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Organisation' . "\0" . 'email', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Organisation' . "\0" . 'matricule', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Organisation' . "\0" . 'photo', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Organisation' . "\0" . 'enabled', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Organisation' . "\0" . 'id'];
        }
