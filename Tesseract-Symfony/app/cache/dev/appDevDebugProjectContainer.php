...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tesseract', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Tesseract\\MOOCBundle\\Resources\\config\\doctrine') => 'Tesseract\\MOOCBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('TesseractMOOCBundle' => 'Tesseract\\MOOCBundle\\Entity'));
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('tesseractcorpesprit@gmail.com');
        $a->setPassword('tesseract123');
        $a->setAuthMode('login');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'tesseractcorpesprit@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'tesseractcorpesprit@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'tesseract123',
