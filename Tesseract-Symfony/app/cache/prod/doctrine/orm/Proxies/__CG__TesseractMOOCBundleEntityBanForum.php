 ...
 */
class BanForum extends \Tesseract\MOOCBundle\Entity\BanForum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BanForum' . "\0" . 'cause', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BanForum' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BanForum' . "\0" . 'duree', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BanForum' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BanForum' . "\0" . 'idUtilisateur'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BanForum $proxy) {
    ...
    public function getCause()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCause', []);
