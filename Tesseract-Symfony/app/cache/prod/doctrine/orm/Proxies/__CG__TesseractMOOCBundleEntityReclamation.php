 ...
 */
class Reclamation extends \Tesseract\MOOCBundle\Entity\Reclamation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Reclamation' . "\0" . 'sujet', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Reclamation' . "\0" . 'description', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Reclamation' . "\0" . 'etat', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Reclamation' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Reclamation' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Reclamation' . "\0" . 'idUtilisateur'];
        }
