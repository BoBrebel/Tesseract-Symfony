 ...
 */
class Utilisateur extends \Tesseract\MOOCBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'username', 'password', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'dateNaissance', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'telephone', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'adresse', 'email', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'photo', 'role', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'score', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'cv', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'etat', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'mailSercours', 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'idOrganisation', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Utilisateur' . "\0" . 'type', 'file', 'usernameCanonical', 'emailCanonical', 'enabled', 'salt', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function getMailSercours()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMailSercours', []);

        return parent::getMailSercours();
    }
    ...
    public function getIdOrganisation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdOrganisation', []);
     ...
     * {@inheritDoc}
     */
    public function setMailSercours($mailSercours)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMailSercours', [$mailSercours]);

        return parent::setMailSercours($mailSercours);
    }
    ...
    public function setIdOrganisation($idOrganisation)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdOrganisation', [$idOrganisation]);
