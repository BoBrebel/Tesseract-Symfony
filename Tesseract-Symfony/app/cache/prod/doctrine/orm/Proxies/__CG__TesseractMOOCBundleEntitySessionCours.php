 ...
 */
class SessionCours extends \Tesseract\MOOCBundle\Entity\SessionCours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SessionCours' . "\0" . 'nbr', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SessionCours' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SessionCours' . "\0" . 'badge', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SessionCours' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SessionCours' . "\0" . 'idUtilisateur', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SessionCours' . "\0" . 'idCours'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SessionCours $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setIdCours(\Tesseract\MOOCBundle\Entity\Cours $idCours)
    {
