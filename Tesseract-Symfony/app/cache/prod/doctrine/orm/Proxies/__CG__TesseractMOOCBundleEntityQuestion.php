 ...
 */
class Question extends \Tesseract\MOOCBundle\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Question' . "\0" . 'question', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Question' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Question' . "\0" . 'idEpreuve'];
        }
