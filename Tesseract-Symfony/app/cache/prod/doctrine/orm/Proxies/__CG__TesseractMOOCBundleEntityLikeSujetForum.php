 ...
 */
class LikeSujetForum extends \Tesseract\MOOCBundle\Entity\LikeSujetForum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\LikeSujetForum' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\LikeSujetForum' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\LikeSujetForum' . "\0" . 'idUtilisateur', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\LikeSujetForum' . "\0" . 'idSujet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LikeSujetForum $proxy) {
