 ...
 */
class Chapitre extends \Tesseract\MOOCBundle\Entity\Chapitre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Chapitre' . "\0" . 'nom', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Chapitre' . "\0" . 'numero', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Chapitre' . "\0" . 'description', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Chapitre' . "\0" . 'resume', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Chapitre' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Chapitre' . "\0" . 'idCours'];
        }
