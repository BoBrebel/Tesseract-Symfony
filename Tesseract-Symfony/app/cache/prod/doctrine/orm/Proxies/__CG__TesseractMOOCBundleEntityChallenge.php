 ...
 */
class Challenge extends \Tesseract\MOOCBundle\Entity\Challenge implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'nom', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'description', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'theme', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'idUtilisateur', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'duree', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Challenge' . "\0" . 'idOrganisation'];
        }
