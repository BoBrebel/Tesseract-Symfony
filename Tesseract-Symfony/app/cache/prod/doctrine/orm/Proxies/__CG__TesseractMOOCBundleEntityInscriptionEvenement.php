 ...
 */
class InscriptionEvenement extends \Tesseract\MOOCBundle\Entity\InscriptionEvenement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\InscriptionEvenement' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\InscriptionEvenement' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\InscriptionEvenement' . "\0" . 'idUtilisateur', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\InscriptionEvenement' . "\0" . 'idEvenement'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InscriptionEvenement $proxy) {
