 ...
 */
class BlogComment extends \Tesseract\MOOCBundle\Entity\BlogComment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BlogComment' . "\0" . 'contenu', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BlogComment' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BlogComment' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BlogComment' . "\0" . 'idUtilisateur', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\BlogComment' . "\0" . 'idPost'];
        }
