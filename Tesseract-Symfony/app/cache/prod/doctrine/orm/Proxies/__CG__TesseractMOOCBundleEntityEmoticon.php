 ...
 */
class Emoticon extends \Tesseract\MOOCBundle\Entity\Emoticon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Emoticon' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Emoticon' . "\0" . 'text', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Emoticon' . "\0" . 'img'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Emoticon $proxy) {
