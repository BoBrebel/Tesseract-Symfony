 ...
 */
class CommentaireCours extends \Tesseract\MOOCBundle\Entity\CommentaireCours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireCours' . "\0" . 'commentaire', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireCours' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireCours' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireCours' . "\0" . 'idUtilisateur', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireCours' . "\0" . 'idCours'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CommentaireCours $proxy) {
