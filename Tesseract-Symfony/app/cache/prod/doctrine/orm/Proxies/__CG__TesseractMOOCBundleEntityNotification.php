 ...
 */
class Notification extends \Tesseract\MOOCBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Notification' . "\0" . 'notification', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Notification' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Notification' . "\0" . 'vue', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Notification' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\Notification' . "\0" . 'idUtilisateur'];
        }
