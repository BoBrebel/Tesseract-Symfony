 ...
 */
class SujetForum extends \Tesseract\MOOCBundle\Entity\SujetForum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'titre', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'description', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'img', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'code', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'link', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\SujetForum' . "\0" . 'idUtilisateur'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SujetForum $proxy) {
