 ...
 */
class CommentaireSujet extends \Tesseract\MOOCBundle\Entity\CommentaireSujet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireSujet' . "\0" . 'contenu', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireSujet' . "\0" . 'date', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireSujet' . "\0" . 'code', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireSujet' . "\0" . 'link', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireSujet' . "\0" . 'id', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireSujet' . "\0" . 'idUtilisateur', '' . "\0" . 'Tesseract\\MOOCBundle\\Entity\\CommentaireSujet' . "\0" . 'idSujet'];
        }
