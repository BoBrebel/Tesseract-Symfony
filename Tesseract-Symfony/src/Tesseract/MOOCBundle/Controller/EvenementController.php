...
use Tesseract\MOOCBundle\Form\EvenementType;
...
class EvenementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TesseractMOOCBundle:Evenement')->findAll();
     ...
     * @Method("POST")
     * @Template("TesseractMOOCBundle:Evenement:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:Evenement')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TesseractMOOCBundle:Evenement:edit.html.twig")
     */
