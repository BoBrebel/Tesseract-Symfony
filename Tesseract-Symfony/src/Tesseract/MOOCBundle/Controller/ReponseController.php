...
use Tesseract\MOOCBundle\Form\ReponseType;
...
class ReponseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TesseractMOOCBundle:Reponse')->findAll();
     ...
     * @Method("POST")
     * @Template("TesseractMOOCBundle:Reponse:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:Reponse')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TesseractMOOCBundle:Reponse:edit.html.twig")
     */
