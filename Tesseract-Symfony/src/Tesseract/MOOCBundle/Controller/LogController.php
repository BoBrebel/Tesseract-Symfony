...
use Tesseract\MOOCBundle\Form\LogType;
...
class LogController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TesseractMOOCBundle:Log:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:Log')->find($id);
        ...
        return $this->render('TesseractMOOCBundle:Log:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TesseractMOOCBundle:Log:edit.html.twig', array(
            'entity'      => $entity,
