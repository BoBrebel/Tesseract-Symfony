...
use Tesseract\MOOCBundle\Entity\Notification;
use Tesseract\MOOCBundle\Form\NotificationType;
...
class NotificationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TesseractMOOCBundle:Notification')->findAll();
     ...
     * @Method("POST")
     * @Template("TesseractMOOCBundle:Notification:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:Notification')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TesseractMOOCBundle:Notification:edit.html.twig")
     */
