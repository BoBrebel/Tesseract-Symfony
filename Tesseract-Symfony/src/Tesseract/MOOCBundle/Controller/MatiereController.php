...
use Tesseract\MOOCBundle\Entity\Matiere;
use Tesseract\MOOCBundle\Form\MatiereType;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TesseractMOOCBundle:Matiere')->findAll();
     ...
     * @Method("POST")
     * @Template("TesseractMOOCBundle:Matiere:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:Matiere')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TesseractMOOCBundle:Matiere:edit.html.twig")
     */
