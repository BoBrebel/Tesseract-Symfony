...
use Tesseract\MOOCBundle\Entity\CommentaireSujet;
use Tesseract\MOOCBundle\Form\CommentaireSujetType;

/**
 * CommentaireSujet controller.
 *
 * @Route("/commentairesujet")
 */
class CommentaireSujetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TesseractMOOCBundle:CommentaireSujet')->findAll();
     ...
     *
     * @Route("/", name="commentairesujet_create")
     * @Method("POST")
     * @Template("TesseractMOOCBundle:CommentaireSujet:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('commentairesujet_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/new", name="commentairesujet_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="commentairesujet_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:CommentaireSujet')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="commentairesujet_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="commentairesujet_update")
     * @Method("PUT")
     * @Template("TesseractMOOCBundle:CommentaireSujet:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}", name="commentairesujet_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('commentairesujet'));
    }
