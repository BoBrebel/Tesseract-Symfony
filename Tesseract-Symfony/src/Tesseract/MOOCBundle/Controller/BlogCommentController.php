...
use Tesseract\MOOCBundle\Entity\BlogComment;
use Tesseract\MOOCBundle\Form\BlogCommentType;
...
class BlogCommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TesseractMOOCBundle:BlogComment')->findAll();
     ...
     * @Method("POST")
     * @Template("TesseractMOOCBundle:BlogComment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:BlogComment')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TesseractMOOCBundle:BlogComment:edit.html.twig")
     */
