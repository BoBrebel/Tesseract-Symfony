...
class CoursController extends Controller
{
     ...
     * @Method("POST")
     * @Template("TesseractMOOCBundle:Cours:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TesseractMOOCBundle:Cours')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TesseractMOOCBundle:Cours:edit.html.twig")
     */
